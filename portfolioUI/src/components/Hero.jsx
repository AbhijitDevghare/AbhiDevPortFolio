...
import "./Hero.css"; // 👈 Import the external CSS for animations
...
function Hero() {
  ...
  Let’s create something amazing together!
        ...
        {/* Social Icons */}
        <div className="flex gap-6 text-blue-500 text-3xl mb-6 justify-center md:justify-start">
          <a
  ...
  href="/resume.pdf"
  download
  className="inline-block bg-blue-600 hover:bg-blue-700 text-white py-3 px-8 rounded-full font-semibold shadow-md transition-transform transform hover:scale-105"
>
  Download Resume
</a>
      ...
      <div>
        {/* <img
          ...
          className="rounded-full w-48 h-48 md:w-56 md:h-56 object-cover shadow-xl border-4 border-blue-300"
        /> */}
